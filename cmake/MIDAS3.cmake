...
function(add_download_target)
  ...
  if(NOT DEFINED MIDAS_DOWNLOAD_TIMEOUT)
    ...
    set(MIDAS_DOWNLOAD_TIMEOUT_STR "TIMEOUT ${MIDAS_DOWNLOAD_TIMEOUT} INACTIVITY_TIMEOUT ${MIDAS_DOWNLOAD_TIMEOUT}")
...
file(DOWNLOAD \"${MIDAS_REST_URL}?method=midas.bitstream.download&checksum=${checksum}&algorithm=${hash_alg}\${tokenArg}\" \"${MIDAS_DATA_DIR}/${base_filename}\" ${MIDAS_DOWNLOAD_TIMEOUT_STR} STATUS status SHOW_PROGRESS)
list(GET status 0 exitCode)
list(GET status 1 errMsg)
if(NOT exitCode EQUAL 0)
