...
Bases: [`MultiFileTileSource`](#large_image_source_multi.MultiFileTileSource), [`GirderTileSource`](../girder_large_image/girder_large_image.html.md#girder_large_image.girder_tilesource.GirderTileSource)
...
#### extensions *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'json': SourcePriority.PREFERRED, 'yaml': SourcePriority.PREFERRED, 'yml': SourcePriority.PREFERRED, None: SourcePriority.MEDIUM}*
...
#### mimeTypes *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'application/json': SourcePriority.PREFERRED, 'application/yaml': SourcePriority.PREFERRED, 'text/yaml': SourcePriority.PREFERRED, None: SourcePriority.FALLBACK}*
