...
Bases: [`TileSource`](../large_image/large_image.tilesource.html.md#large_image.tilesource.base.TileSource)
...
* **Parameters:**
  ...
  * **failBelowMinLevel** – if True and a tile is requested outside of
...
#### extensions *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {None: SourcePriority.MANUAL}*
