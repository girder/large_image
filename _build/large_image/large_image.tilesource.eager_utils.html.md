...
### large_image.tilesource.eager_utils.eager_wsi_operations.calculate_slide_dimensions(source: [large_image.tilesource.base.TileSource](large_image.tilesource.html.md#large_image.tilesource.base.TileSource), region: dict[str, int] | None = None, scale: dict[str, Any] | None = None, tile_size: dict[str, int] | None = None, source_scale: dict[str, Any] | None = None, \*\*kwargs)
