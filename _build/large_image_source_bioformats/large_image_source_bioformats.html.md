...
Bases: [`BioformatsFileTileSource`](#large_image_source_bioformats.BioformatsFileTileSource), [`GirderTileSource`](../girder_large_image/girder_large_image.html.md#girder_large_image.girder_tilesource.GirderTileSource)
...
#### extensions *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'czi': SourcePriority.HIGH, 'ets': SourcePriority.LOW, 'lif': SourcePriority.MEDIUM, 'vsi': SourcePriority.PREFERRED, None: SourcePriority.FALLBACK}*
...
#### mimeTypes *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'image/czi': SourcePriority.HIGH, 'image/vsi': SourcePriority.PREFERRED, None: SourcePriority.FALLBACK}*
