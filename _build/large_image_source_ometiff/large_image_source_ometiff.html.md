...
Bases: [`OMETiffFileTileSource`](#large_image_source_ometiff.OMETiffFileTileSource), [`GirderTileSource`](../girder_large_image/girder_large_image.html.md#girder_large_image.girder_tilesource.GirderTileSource)
...
Bases: [`TiffFileTileSource`](../large_image_source_tiff/large_image_source_tiff.html.md#large_image_source_tiff.TiffFileTileSource)
...
#### extensions *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'ome': SourcePriority.PREFERRED, 'tif': SourcePriority.MEDIUM, 'tiff': SourcePriority.MEDIUM, None: SourcePriority.LOW}*
...
#### mimeTypes *: dict[str | None, [SourcePriority](../large_image/large_image.html.md#large_image.constants.SourcePriority)]* *= {'image/tiff': SourcePriority.MEDIUM, 'image/x-tiff': SourcePriority.MEDIUM}*
