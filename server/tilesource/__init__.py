...
sourceList = [
    ...
    {'moduleName': '.ometiff', 'className': 'OMETiffGirderTileSource',
     'girder': True},
    {'moduleName': '.gdalsource', 'className': 'GDALFileTileSource'},
    {'moduleName': '.gdalsource', 'className': 'GDALGirderTileSource', 'girder': True},
    {'moduleName': '.mapniksource', 'className': 'MapnikFileTileSource'},
