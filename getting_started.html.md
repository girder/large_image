...
To read more about accepted file formats, visit the [Image Formats](formats.html.md) page.

These examples use `sample.tiff` as an example – any readable image can be used in this case. Visit [demo.kitware.com](https://demo.kitware.com/histomicstk/#folder/589e030a92ca9a00118a6166) to download a sample image.
...
To see more examples of using `large-image-source-zarr` to write images, see [Jupyter Notebook Examples](notebooks.html.md) and the [Zarr Sink Tests](https://github.com/girder/large_image/blob/master/test/test_sink.py).
